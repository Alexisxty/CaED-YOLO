...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           'GhostBottleneck', 'Bottleneck', 'BottleneckCSP', 'Proto', 'RepC3','GAM_Attention','ResBlock_CBAM',
           'GCT','C3STR','SwinV2_CSPB','CoT3','GlobalContext','ScConv','EMA','C2fattention1','C2fattention2',
           'EffectiveSE','BoT3','GAM_Attention','GlobalContext','GatherExcite','TripletAttention','ECAAttention',
           'ShuffleAttention','SEAttention')
...
class C2fattention1(nn.Module):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.c = int(c2 * e)  # hidden channels
        self.cv1 = Conv(c1, 2 * self.c, 1, 1)
        self.m1 = nn.ModuleList([EMA(self.c)])  # 添加在Bottleneck之前
        self.cv2 = Conv((2 + n) * self.c, c2, 1)  # optional act=FReLU(c2)
        self.m = nn.ModuleList(Bottleneck(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
